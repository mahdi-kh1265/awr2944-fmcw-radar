local out_path = [[C:/Users/khams008/Documents/awr2944-fmcw-radar/exp_lau_probe/ti/probe_logs/manual_gui_no_direct_fullreset_connect_result.json]]
local jsonl_path = [[C:/Users/khams008/Documents/awr2944-fmcw-radar/exp_lau_probe/ti/probe_logs/manual_gui_no_direct_fullreset_connect_progress.jsonl]]
...
local fb_ret, cv_ret, dv_ret, sop_ret, connect_ret = nil, nil, nil, nil, nil
...
local ok, err = pcall(function()
    ...
    -- Do NOT call ar1.FullReset() directly here.
    -- GUI log shows SOPControl path opens GPIO/Board control ports and performs the working reset internally.
