...
local result = {
    probe_id = "8f3e980e-dcd9-480f-a1f8-d582c8f166ca",
...
local file, err = io.open("C:/Users/khams008/Documents/awr2944-fmcw-radar/exp_lau_probe/ti/probe_logs/inventory_result.json", "w")
if file then
    file:write(json_str)
    file:close()
end
