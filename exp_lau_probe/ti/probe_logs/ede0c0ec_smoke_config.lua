...
local run_id = "ede0c0ec"
local run_stage = "smoke_config"
local progress_path = [[C:/Users/khams008/Documents/awr2944-fmcw-radar/exp_lau_probe/ti/probe_logs/ede0c0ec_smoke_config_progress.jsonl]]

local out_path = [[C:/Users/khams008/Documents/awr2944-fmcw-radar/exp_lau_probe/ti/probe_logs/ede0c0ec_smoke_config_result.json]]
local result = {
    run_id = "ede0c0ec",
    executed = true,
    success = false,
