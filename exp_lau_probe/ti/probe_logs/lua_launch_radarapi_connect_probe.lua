local run_id = "3b277b79"
local out_path = [[C:/Users/khams008/Documents/awr2944-fmcw-radar/exp_lau_probe/ti/probe_logs/lua_launch_radarapi_connect_probe_result.json]]
local jsonl_path = [[C:/Users/khams008/Documents/awr2944-fmcw-radar/exp_lau_probe/ti/probe_logs/lua_launch_radarapi_connect_probe_progress.jsonl]]
local mode = "rttt-no-showgui"
...
RSTD.LoadExpose(registers_xml)
    ...
    if mode == "showgui-plus-loadsettings" or mode == "full" then
        ...
        local ls_ok = pcall(function() return ar1.LoadSettings([[C:\\Users\\khams008\\AppData\\Roaming\\RSTD\\argui.ini]]) end)
