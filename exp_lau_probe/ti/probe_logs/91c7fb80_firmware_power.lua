...
local out_path = [[C:/Users/khams008/Documents/awr2944-fmcw-radar/exp_lau_probe/ti/probe_logs/91c7fb80_firmware_power_result.json]]
local progress_path = [[C:/Users/khams008/Documents/awr2944-fmcw-radar/exp_lau_probe/ti/probe_logs/91c7fb80_firmware_power_result_progress.jsonl]]
...
local function safeCall(funcName, func, critical)
    ...
    if critical and (not ok or (type(ret) == 'number' and ret ~= 0)) then
        ...
        saveResult()
        error("Critical failure in " .. funcName)
    end
    return ret
end
...
safeCall("DownloadBSSFw", function() return ar1.DownloadBSSFw(bss_path) end, true)
RSTD.Sleep(1000)
...
safeCall("DownloadMSSFw", function() return ar1.DownloadMSSFw(mss_path) end, true)
RSTD.Sleep(1000)

safeCall("GetMSSFwVersion", function() return ar1.GetMSSFwVersion() end, false)

-- 3. Power On
safeCall("PowerOn", function() return ar1.PowerOn(0, 1000, 0, 0) end, true)
RSTD.Sleep(2000)

-- 4. RF Enable
safeCall("RfEnable", function() return ar1.RfEnable() end, true)
RSTD.Sleep(1000)
