...
local run_id = "b475130e"
local run_stage = "firmware_power"
local progress_path = [[C:/Users/khams008/Documents/awr2944-fmcw-radar/exp_lau_probe/ti/probe_logs/b475130e_firmware_power_result_progress.jsonl]]

local out_path = [[C:/Users/khams008/Documents/awr2944-fmcw-radar/exp_lau_probe/ti/probe_logs/b475130e_firmware_power_result.json]]
local result = {
    run_id = "b475130e",
    executed = true,
    success = false,
