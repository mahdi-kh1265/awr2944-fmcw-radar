...
]], "test_probe_123", tostring(probe_executed), tostring(ar1_available), tostring(write_to_log_available))

local file, err = io.open("C:/Users/khams008/Documents/awr2944-fmcw-radar/.pytest-tmp3/test_generate_probe_script1/probe_result.json", "w")
if file then
    file:write(json_str)
    file:close()
else
