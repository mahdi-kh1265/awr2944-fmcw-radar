...
]], "946f3e99-4faa-4085-9305-95d8c561da28", tostring(probe_executed), tostring(ar1_available), tostring(write_to_log_available))

local file, err = io.open("C:/Users/khams008/Documents/awr2944-fmcw-radar/.pytest-tmp3/test_generate_probe_script0/test_exp_probe/ti/probe_logs/probe_result.json", "w")
if file then
    file:write(json_str)
    file:close()
else
